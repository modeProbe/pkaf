...
public class ConversationResource {
    ...
    public List<Conversation> getAllConversations() {
        ...
        List<Conversation> conversations = conversationRepository.findAllWithEagerRelationships();
        return conversations;
    }

    /**
     * GET  /conversations-formuser : get all the conversations.
     *
     * @return the ResponseEntity with status 200 (OK) and the list of conversations in body
     */
    @GetMapping("/conversations-fromuser/{id}")
    @Timed
    public List<Conversation> getAllConversationsFromUser(@PathVariable Long id) {
        log.debug("REST request to get all Conversations");
        List<Conversation> conversations = conversationRepository.findAllConversationOfUser(id);
        return conversations;
    }
    ...
    public ResponseEntity<Conversation> getConversation(@PathVariable Long id) {
        ...
        Conversation conversation = conversationRepository.findOneWithEagerRelationships(id);
